...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 09 mars 2022 à 15:11
...
--
-- Déchargement des données de la table `food_recipe`
--

INSERT INTO `food_recipe` (`id_food_recipe`, `food_recipe_ingredients`, `food_recipe_quantity`, `food_recipe_method`, `id_user`, `food_image`, `food_recipe_name`) VALUES
(1, 'ingerdient', 'quantity', 'method', NULL, 'Images/guinnessBrownie.jpg', 'Guinness Brownies');
...
CREATE TABLE IF NOT EXISTS `party` (
  ...
  `type_party` tinyint(1) NOT NULL,
  `image_party` varchar(60) CHARACTER SET utf16 COLLATE utf16_general_ci NOT NULL,
  `name_party` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `recipe_party` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `method_party` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `party` (`id_party`, `type_party`, `image_party`, `name_party`, `recipe_party`, `method_party`) VALUES
(1, 1, 'Images/BabyGuinness.jpg', 'Baby Guinness Shooter', 'recipe', 'methood'),
(2, 1, 'Images/BazookaJoe.jpg', 'bazooka joe', 'recipe', 'method'),
(3, 2, 'Images/cupcakes.jpg', 'Alcohol Infused Cupcakes', 'recipe', 'method'),
(5, 2, 'Images/WatermelonVodka.jpg', ' Vodka Charged Watermelon', 'recipe Watermelon', 'Method Watermelon');
...
--
-- Déchargement des données de la table `shots_recipe`
--

INSERT INTO `shots_recipe` (`id_shots_recipe`, `shots_image`, `shots_recipe_name`, `shots_recipe_ingredients`, `shots_recipe_quantity`, `shots_recipe_method`) VALUES
(1, 'Images/BabyGuinness.jpg', 'Baby Guinness', 'shot ingredients', 'shot quantity', 'shot method'),
(2, 'Images/BazookaJoe.jpg', 'Bazooka Joe', 'shotbaz ing', 'shotbaz quantity', 'shotbaz method'),
(3, 'Images/cupcakes.jpg', 'food recipe', 'food ingredents', 'food quantity', 'food method');
